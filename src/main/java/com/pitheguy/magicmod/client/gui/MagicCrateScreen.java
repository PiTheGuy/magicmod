...
public class MagicCrateScreen extends AbstractContainerScreen<MagicCrateContainer> {
    private static final ResourceLocation TEXTURE = new ResourceLocation("magicmod", "textures/gui/magic_crate.png");
    public MagicCrateScreen(MagicCrateContainer screenContainer, Inventory inv, Component titleIn) {
