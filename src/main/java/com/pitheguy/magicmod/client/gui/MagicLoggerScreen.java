...
public class MagicLoggerScreen extends AbstractContainerScreen<MagicLoggerContainer> {
    private static final ResourceLocation TEXTURE = new ResourceLocation("magicmod", "textures/gui/magic_miner.png");
    public MagicLoggerScreen(MagicLoggerContainer screenContainer, Inventory inv, Component titleIn) {
