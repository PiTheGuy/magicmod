...
public class MagicInfuserScreen extends AbstractContainerScreen<MagicInfuserContainer> {
    private static final ResourceLocation TEXTURE = new ResourceLocation("magicmod", "textures/gui/magic_infuser.png");
    public MagicInfuserScreen(MagicInfuserContainer screenContainer, Inventory inv, Component titleIn) {
