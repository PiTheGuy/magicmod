...
public class RegistryHandler {
    ...
    public static final RegistryObject<HoeItem> MAGIC_HOE = ITEMS.register("magic_hoe", () ->
            new MagicHoe(ModItemTiers.MAGIC, 50, 0.0f, new Item.Properties().tab(MagicMod.TAB), 1));
    ...
    public static final RegistryObject<HoeItem> REINFORCED_MAGIC_HOE = ITEMS.register("reinforced_magic_hoe", () ->
            new ReinforcedMagicHoe(ModItemTiers.REINFORCED_MAGIC, 150, 0.0f, new Item.Properties().tab(MagicMod.TAB), 3));
    ...
    public static final RegistryObject<HoeItem> OBSIDIAN_PLATED_REINFORCED_MAGIC_HOE = ITEMS.register("obsidian_plated_reinforced_magic_hoe", () ->
            new ObsidianPlatedReinforcedMagicHoe(ModItemTiers.OBSIDIAN_PLATED_REINFORCED_MAGIC, 350, 0.0f, new Item.Properties().tab(MagicMod.TAB), 5));

    //Magic Armor
    public static final RegistryObject<ArmorItem> MAGIC_HELMET = ITEMS.register("magic_helmet", () ->
            new CustomArmorMagic(ModArmorMaterials.MAGIC, EquipmentSlot.HEAD, new Item.Properties().tab(MagicMod.TAB)));
    public static final RegistryObject<ArmorItem> MAGIC_CHESTPLATE = ITEMS.register("magic_chestplate", () ->
            new CustomArmorMagic(ModArmorMaterials.MAGIC, EquipmentSlot.CHEST, new Item.Properties().tab(MagicMod.TAB)));
    public static final RegistryObject<ArmorItem> MAGIC_LEGGINGS = ITEMS.register("magic_leggings", () ->
            new CustomArmorMagic(ModArmorMaterials.MAGIC, EquipmentSlot.LEGS, new Item.Properties().tab(MagicMod.TAB)));
    public static final RegistryObject<ArmorItem> MAGIC_BOOTS = ITEMS.register("magic_boots", () ->
            new CustomArmorMagic(ModArmorMaterials.MAGIC, EquipmentSlot.FEET, new Item.Properties().tab(MagicMod.TAB)));
    ...
    public static final RegistryObject<ArmorItem> REINFORCED_MAGIC_HELMET = ITEMS.register("reinforced_magic_helmet", () ->
            new CustomArmorMagic(ModArmorMaterials.REINFORCED_MAGIC, EquipmentSlot.HEAD, new Item.Properties().tab(MagicMod.TAB)));
    public static final RegistryObject<ArmorItem> REINFORCED_MAGIC_CHESTPLATE = ITEMS.register("reinforced_magic_chestplate", () ->
            new CustomArmorMagic(ModArmorMaterials.REINFORCED_MAGIC, EquipmentSlot.CHEST, new Item.Properties().tab(MagicMod.TAB)));
    public static final RegistryObject<ArmorItem> REINFORCED_MAGIC_LEGGINGS = ITEMS.register("reinforced_magic_leggings", () ->
            new CustomArmorMagic(ModArmorMaterials.REINFORCED_MAGIC, EquipmentSlot.LEGS, new Item.Properties().tab(MagicMod.TAB)));
    public static final RegistryObject<ArmorItem> REINFORCED_MAGIC_BOOTS = ITEMS.register("reinforced_magic_boots", () ->
            new CustomArmorMagic(ModArmorMaterials.REINFORCED_MAGIC, EquipmentSlot.FEET, new Item.Properties().tab(MagicMod.TAB)));
    ...
    public static final RegistryObject<ArmorItem> OBSIDIAN_PLATED_REINFORCED_MAGIC_HELMET = ITEMS.register("obsidian_plated_reinforced_magic_helmet", () ->
            new CustomArmorMagic(ModArmorMaterials.OBSIDIAN_PLATED_REINFORCED_MAGIC, EquipmentSlot.HEAD, new Item.Properties().tab(MagicMod.TAB)));
    public static final RegistryObject<ArmorItem> OBSIDIAN_PLATED_REINFORCED_MAGIC_CHESTPLATE = ITEMS.register("obsidian_plated_reinforced_magic_chestplate", () ->
            new CustomArmorMagic(ModArmorMaterials.OBSIDIAN_PLATED_REINFORCED_MAGIC, EquipmentSlot.CHEST, new Item.Properties().tab(MagicMod.TAB)));
    public static final RegistryObject<ArmorItem> OBSIDIAN_PLATED_REINFORCED_MAGIC_LEGGINGS = ITEMS.register("obsidian_plated_reinforced_magic_leggings", () ->
            new CustomArmorMagic(ModArmorMaterials.OBSIDIAN_PLATED_REINFORCED_MAGIC, EquipmentSlot.LEGS, new Item.Properties().tab(MagicMod.TAB)));
    public static final RegistryObject<ArmorItem> OBSIDIAN_PLATED_REINFORCED_MAGIC_BOOTS = ITEMS.register("obsidian_plated_reinforced_magic_boots", () ->
            new CustomArmorMagic(ModArmorMaterials.OBSIDIAN_PLATED_REINFORCED_MAGIC, EquipmentSlot.FEET, new Item.Properties().tab(MagicMod.TAB)));
    ...
    public static final RegistryObject<Block> MAGIC_GLUE_BLOCK = BLOCKS.register("magic_glue_block", () -> new Block(Block.Properties.of(Material.METAL).strength(4.5f, 6.5f).sound(SoundType.SLIME_BLOCK).requiresCorrectToolForDrops().jumpFactor(0.0f).speedFactor(0.1f)));
    public static final RegistryObject<Block> MAGIC_VEIN = BLOCKS.register("magic_vein", MagicVein::new);
    public static final RegistryObject<Block> MAGIC_INFUSED_STONE = BLOCKS.register("magic_infused_stone", () -> new Block(Block.Properties.of(Material.METAL).strength(2.0f, 8.0f).sound(SoundType.STONE).requiresCorrectToolForDrops()));
    ...
    //Enchantments
    public static final RegistryObject<Enchantment> MAGIC_FINDER = ENCHANTMENTS.register("magic_finder", () -> new MagicFinderEnchantment(Enchantment.Rarity.VERY_RARE, EnchantmentCategory.create("magic_tool", item -> item instanceof MagicPickaxe || item instanceof MagicAxe || item instanceof MagicShovel), new EquipmentSlot[]{EquipmentSlot.MAINHAND}));
    public static final RegistryObject<Enchantment> VEINMINER = ENCHANTMENTS.register("veinminer", () -> new VeinminerEnchantment(Enchantment.Rarity.VERY_RARE, EnchantmentCategory.create("pickaxe", item -> item instanceof MagicPickaxe), new EquipmentSlot[]{EquipmentSlot.MAINHAND}));
}