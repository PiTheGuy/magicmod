...
public class ModTileEntityTypes {
    ...
    public static final RegistryObject<TileEntityType<MagicMinerTileEntity>> MAGIC_MINER = TILE_ENTITY_TYPES.register("magic_miner",() -> TileEntityType.Builder.create(MagicMinerTileEntity::new, RegistryHandler.MAGIC_MINER.get()).build(null));
}